...
public class Customer implements UserDetails {
    ...
    public Customer(Integer id, String email, String password, String name, Integer age, Gender gender, String profileImageId) {
        this(id, email, password, name, age, gender);
